...
const { bookAppointment, getDoctorAppointments, getHospitalAppointments, getDoctorAppointmentsByDate, updateAppointmentStatus, getPatientActiveQueue } = require('../controllers/appointmentController');
...
router.get('/patient/active', protect, authorize('patient'), getPatientActiveQueue);
router.get('/doctor', protect, authorize('doctor'), getDoctorAppointments);
router.get('/doctor/history', protect, authorize('doctor'), getDoctorAppointmentsByDate);
